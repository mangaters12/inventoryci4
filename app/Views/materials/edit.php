...
<body>
    <div class="container">
        ...
        <form action="/materials/update/<?= $material['id'] ?>" method="post" class="form-horizontal">
            <div class="form-group">
                <label for="nama_barang" class="col-sm-2 control-label">Nama Barang:</label>
                <div class="col-sm-10">
                    <input type="text" name="nama_barang" value="<?= $material['nama_barang'] ?>" required class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="stok_barang" value="<?= $material['stok_barang'] ?>" required class="form-control">
                </div>
            </div>
